...
run-wasm-dashboard:
	...
	@echo ""
	@echo "Setup:"
	@echo "  1. Start kubo-rs daemon:  cargo run --bin kubo-rs -- ipfs daemon --online"
	@echo "  2. Enable CORS:"
	@echo "     cargo run --bin kubo-rs -- ipfs config --json API.HTTPHeaders.Access-Control-Allow-Origin '\"[\"http://localhost:8080\"]\"'"
